...
public class ChangePW_3 extends ATMPanel implements ActionListener{
	...
	private JButton returnCard, ok, backMainWindow;//退卡，确认，回主菜单
	private Clocker clocker;//计时器
	private JLabel tips, label, label_1, hint;//提示，输入提示，安全提示
	private ATMTextField passwordField;//密码输入框
	private String spw,pw;//二次密码，一次密码
	
	public ChangePW_3(){//修改成功时的构造器，结果界面
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource()==returnCard){
			...
			if(pw.length()==6 && spw.equals(pw)){//前后密码一致
